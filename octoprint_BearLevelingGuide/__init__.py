...
class BearLevelingGuidePlugin(octoprint.plugin.SimpleApiPlugin,
	...
	def get_settings_defaults(self):
		return dict(
			...
			move_gcode = 'G1 Z60 X60 Y210 F6000',
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/BearLevelingGuide.js"],
			css=["css/BearLevelingGuide.css"],
			less=["less/BearLevelingGuide.less"],
	...
	def get_update_information(self):
		...
		# for details.
		return dict(
			BearLevelingGuide=dict(
				displayName="3DXFAB BEAR Leveling Guide Plugin",
				displayVersion=self._plugin_version,

				# version check: github repository
				type="github_release",
				user="3dxfab",
				repo="OctoPrint-BearLevelingGuide",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/3dxfab/OctoPrint-BearLevelingGuide/archive/{target_version}.zip"
			)
		)
...
__plugin_name__ = "Bear Leveling Guide"
__plugin_pythoncompat__ = ">=2.7,<4"

def __plugin_load__():
	global __plugin_implementation__
	__plugin_implementation__ = BearLevelingGuidePlugin()
